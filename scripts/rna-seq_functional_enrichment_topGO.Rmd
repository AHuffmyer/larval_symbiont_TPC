...
```
2540 DEGs with annotation informaiton
...
The reduced list of terms is 93 terms that falls under 34 parent terms.
...
ggsave(parent_enrich_plot5, filename="figures/rna_seq/topGO/parent_lipid_terms.png", width=6, height=3)
```
...
The reduced list of terms is 293 terms that falls under 62 parent terms.
...
The reduced list of terms is 173 terms that falls under 50 parent terms.
...
ggsave(interaction_enrich_plot3, filename="figures/rna_seq/topGO/interaction_enrichment_individual_terms.png", width=10, height=15)
