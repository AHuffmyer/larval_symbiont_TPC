...
NEED TO FIGURE OUT EXPORT ISSUE 
...
TEMPORARY: Check individual runs 
09 - 
10 - 

HAVING ISSUES WITH IT NOT MAKING PROPER CUT OFFS FOR RUNS 13-16 (maybe others?)
...
for(file in 1:length(file.names)) { # for every file in list start at the first and run this following function
  ...
  # maybe add step here to filter by plate that is being read in and pull out start and end times for each? from run info data?
