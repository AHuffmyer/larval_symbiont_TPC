...
pca2<-ggplot2::autoplot(scaled.pca, data=wide_data, frame.colour="parent", loadings=FALSE,  colour="parent", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=TRUE, loadings.label.size=5, loadings.label.vjust=-1, size=4) + 
  ...
  scale_fill_manual(name="Parental Phenotype", values=c("Wildtype"="gray", "Bleached"="orange", "Nonbleached"="brown4"))+
  theme_classic()+
  geom_text(x=0, y=-0.35, label="p=0.029", size=8)+
...
pca2b<-ggplot2::autoplot(scaled.pca, data=wide_data, frame.colour="temperature", loadings=FALSE,  colour="temperature", loadings.label.colour="black", loadings.colour="black", loadings.label=FALSE, frame=TRUE, loadings.label.size=5, loadings.label.vjust=-1, size=4) + 
  ...
  theme_classic()+
  geom_text(x=0, y=-0.35, label="p=0.042", size=8)+
   theme(legend.text = element_text(size=14), 
         legend.position="right",
        plot.background = element_blank(),
        legend.title = element_text(size=14, face="bold"), 
...
plotIndiv(MyResult.plsda, col=cols, ind.names = FALSE, legend=FALSE, legend.title = "A", ellipse = TRUE, title="", style = "graphics", centroid=FALSE, point.lwd = 2, cex=2)
dev.off() 
...
plotIndiv(MyResult.plsda, col=cols, ind.names = FALSE, legend=FALSE, legend.title = "B", ellipse = TRUE, title="", style = "graphics", centroid=FALSE, point.lwd = 2, cex=2)
dev.off() 
...
plot_sign2<-classes%>%
  ...
  facet_wrap(~ontology, scales="free", nrow=3, ncol=5)+
  geom_boxplot(outliers=FALSE)+
  geom_point()+
  theme_classic()+
    ylab("% Class Composition")+
...
ggsave(plot_sign2, filename="figures/lipids/sign_classes_parent.jpeg", width=9, height=8)
```
...
fa_plot2<-fa_pufa%>%
  ...
  ylim(0,0.028)+
  ggtitle("F")+
  geom_text(inherit.aes=FALSE, x=2, y=0.025, label="p[parent]<0.001", size=4)+
  geom_text(inherit.aes=FALSE, x=2, y=0.023, label="p[temperature]<0.001", size=4)+
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), 
        legend.title=element_blank(),
...
st_plot<-lipids_filtered%>%
  ...
  ylim(0,0.0015)+
  ggtitle("E")+
  geom_text(inherit.aes=FALSE, x=2, y=0.0012, label="p[parent]<0.001", size=4)+
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), 
        legend.title=element_blank(),
...
ratio_plot1<-epa_dha%>%
  ...
  geom_text(inherit.aes=FALSE, x=2, y=3, label="p[parent]<0.001", size=4)+
  scale_colour_manual(values=c("orange", "darkred", "darkgray"))+
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), 
        legend.position="right", 
