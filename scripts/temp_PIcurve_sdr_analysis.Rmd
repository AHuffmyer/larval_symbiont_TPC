...
TukeyHSD(model, c("Temperature"))
```
No effect of temp at high light 
...
TukeyHSD(model, c("Temperature"))
```
WT and MIX are different, WT is higher than MIX. No difference between MIX and C or WT and C (almost sign). There is higher dark respiration in WT. Dark respiration increases with temp then crashes at 36C. 
...
pairs(emm)
```
There are light and temperature effects. There is almost a symbiont x temperature effect (p=0.06). 
