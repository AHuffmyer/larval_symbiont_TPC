...
- Load data 
- Plot full data set to visualize
- Perform localized linear regressions to extract metabolic rates for each treatment group
- Plot metabolic rates to visualize 
- Statistically compare metabolic rates as a function of temperature, light, and symbiont

Questions for AUS team: 

- Explain O2 Fo vs O2 Fm
- Can we use FvFm and NPQ from these worksheets?
- How to get this worksheet fully reproducible
- Explain units of O2 fluorescence and how this relates to amount of oxygen 
- Can/should we normalize O2 fluorescence to larvae and water volume to get actual oxygen concentrations per larvae? 
- Same number of larvae in each well? 
