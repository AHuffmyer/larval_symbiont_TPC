...
*Discussion point: Shoud you use genes from your dataset or genes from the genome? When would you use either option?*  
...
interaction_deg_FC <- interaction_DEG_list %>%
  mutate(label=paste0(Description, "-", gene, "-", Preferred_name))%>%
  dplyr::arrange(log2FoldChange) %>%
