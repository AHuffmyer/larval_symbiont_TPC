...
We will use the last 5 min averaged for QY and NPQ  in these phases to give final value reached in each phase. 
...
light_plot<-df%>%
  ...
  geom_text(label="QY & NPQ  \n~ Temp", x=45, y=500, size=4, colour="darkred")+
