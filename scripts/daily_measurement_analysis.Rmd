...
parent_names<-c("Cladocopium" = "Susceptible (C)", "Mixed" = "Resistant (C/D)", "Wildtype" = "Wildtype (C/D)")

parent_colors<-c("Cladocopium" = "orange",   # calm blue
                 "Mixed" = "darkred", # stressed purple
                 "Wildtype" = "darkgray") 
...
daily_treatment_summary<-daily_calc.long %>%
  ...
  scale_colour_manual(name = "Parent (Symbiont)", values = parent_colors, labels = parent_names) +
  scale_x_discrete(name = "Parent (Symbiont)", labels = parent_names) +
  ylab("Value") +
  ggtitle("A")+
...
ggsave(filename="figures/environmental/summary_daily_measurements.png", plot=daily_treatment_summary, dpi=300, width=7, height=6, units="in")
```
