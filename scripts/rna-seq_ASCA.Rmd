...
-> Pull out "most important" genes on each PC
-> Describe PCs1-3 primarily 
-> Functional enrichment and heat map of important genes to each pattern 

1. ASCA for high level patterns
2. DESeq2 for specific comparisons of interest (B vs NB at 33°C) for testing hypotheses 

REPEAT WITH LIPIDS 
- ASCA first 
- Then VIP/PLSDA as follow up for specific tests 
