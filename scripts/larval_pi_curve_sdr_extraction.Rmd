...
colnames(Photo.R) <- c("Date", "Run","Sample.ID","Chamber.ID","Intercept", "Interval", "umol.L.min")

Photo.Rb <- data.frame(matrix(NA, ncol=6))
colnames(Photo.Rb) <- c("Date", "Run","Sample.ID","Chamber.ID","Intercept", "Interval", "umol.L.min")
