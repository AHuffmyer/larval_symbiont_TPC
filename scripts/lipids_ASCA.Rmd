...
plot(res_all, component = 1, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c("darkgray", "darkred", "orange"))
dev.off()

# PC2 genes
pdf(file="figures/lipids/asca/PC2_genes.pdf", width=16, height=6)
plot(res_all, component = 2, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c("darkgray", "darkred", "orange"))
dev.off()

# PC3 genes
pdf(file="figures/lipids/asca/PC3_genes.pdf", width=16, height=6)
plot(res_all, component = 3, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c("darkgray", "darkred", "orange"))
dev.off()
```
...
pc_plot1<-pc1_conc%>%
  ...
  scale_colour_manual(name="Parent (Symbiont)", labels=c("Wildtype (C/D)", "Nonbleached (C/D)", "Bleached (C)"), values=c("darkgray", "darkred", "orange"))+
