...
pairs(emm)
```
There is an effect of temperature on P net at high light. 
...
```
Ratios peak at 30C and are higher at high light. 
...
TukeyHSD(model, "Temperature")
```
P gross increases with temperature and is higher at high light. 
...
TukeyHSD(model, "Temperature")
```
P net increases with temperature and is higher in high light. 
