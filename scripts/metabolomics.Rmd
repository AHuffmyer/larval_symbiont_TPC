...
unique_to_kept1 <- base::setdiff(kept_metabolites, kept_metabolites2) # Elements in kept1 but not in kept2
unique_to_kept2 <- base::setdiff(kept_metabolites2, kept_metabolites) # Elements in kept2 but not in kept1
