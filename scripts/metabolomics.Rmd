...
```
This retained 89 VIPs.

View scree plot. 

```{r}
scaled.pca<-prcomp(vip_data_parent[c(4:92)], scale=TRUE, center=TRUE) 
...
```{r}
# scale data
vegan <- scale(vip_data_parent[c(4:92)])
...
adonis2(formula = vegan ~ parent * temperature, data = vip_data_parent, method = "eu")
                   Df SumOfSqs      R2      F Pr(>F)  
parent              2    250.0 0.05508 1.3985  0.084 .
temperature         2    130.2 0.02867 0.7280  0.905  
parent:temperature  4    315.3 0.06946 0.8818  0.701  
Residual           43   3843.6 0.84679                
Total              51   4539.0 1.00000   
...
```{r}
vip_data_temperature<-metabolites%>%
  ungroup()%>%
  select(!type)%>%
  select(!protein.ug)%>%
  select(!mean_blank)%>%
...
```
This retained 92 VIPs.

View scree plot. 

```{r}
scaled.pca<-prcomp(vip_data_temperature[c(4:95)], scale=TRUE, center=TRUE) 
...
```{r}
# scale data
vegan <- scale(vip_data_temperature[c(4:95)])
...
adonis2(formula = vegan ~ parent * temperature, data = vip_data_temperature, method = "eu")
                   Df SumOfSqs      R2      F Pr(>F)   
parent              2    175.4 0.03738 0.9693  0.543   
temperature         2    298.4 0.06359 1.6489  0.004 **
parent:temperature  4    328.1 0.06992 0.9066  0.798   
Residual           43   3890.2 0.82911                 
Total              51   4692.0 1.00000   
...
```{r}
vip_data_interaction<-metabolites%>%
  ungroup()%>%
  select(!type)%>%
  select(!protein.ug)%>%
  select(!mean_blank)%>%
...
```
This retained 100 VIPs.

View scree plot. 

```{r}
scaled.pca<-prcomp(vip_data_interaction[c(4:103)], scale=TRUE, center=TRUE) 
...
```{r}
# scale data
vegan <- scale(vip_data_interaction[c(4:103)])
...
adonis2(formula = vegan ~ parent * temperature, data = vip_data_interaction, method = "eu")
                   Df SumOfSqs      R2      F Pr(>F)
parent              2    239.1 0.04687 1.2284  0.101
temperature         2    225.5 0.04422 1.1589  0.145
parent:temperature  4    451.3 0.08850 1.1596  0.102
Residual           43   4184.1 0.82041              
Total              51   5100.0 1.00000       
