...
# get start vals
start_vals <- get_start_vals(tpc_data$Temperature,tpc_data$R.nmol.org.min, model_name = 'sharpeschoolhigh_1981')

# get limits
low_lims <- get_lower_lims(tpc_data$Temperature,tpc_data$R.nmol.org.min, model_name = 'sharpeschoolhigh_1981')
upper_lims <- get_upper_lims(tpc_data$Temperature,tpc_data$R.nmol.org.min, model_name = 'sharpeschoolhigh_1981')
